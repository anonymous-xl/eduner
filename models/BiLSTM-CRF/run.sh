...
if [ "$1" = "train" ]
then
  python run.py train ./data/train.txt ./data/dev.txt ./vocab/sent_vocab.json ./vocab/tag_vocab.json --cuda
elif [ "$1" = "train-without-cuda" ]
then
  python run.py train ./data/train.txt ./data/dev.txt ./vocab/sent_vocab.json ./vocab/tag_vocab.json
elif [ "$1" = "test" ]
then
