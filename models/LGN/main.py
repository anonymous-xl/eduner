...
def batchify_with_label(input_batch_list, gpu):
    ...
    mask = autograd.Variable(torch.zeros((batch_size, max_sent_len))).bool()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', help='Training set.', default='data/DisciplineNERBMES/train.csv')
    parser.add_argument('--dev', help='Developing set.', default='data/DisciplineNERBMES/dev.csv')
    parser.add_argument('--test', help='Testing set.', default='data/DisciplineNERBMES/test.csv')
    parser.add_argument('--raw', help='Raw file for decoding.')
    parser.add_argument('--output', help='Output results for decoding.')
    parser.add_argument('--saved_set', help='Path of saved data set.', default='data/DisciplineNERBMES/saved.dset')
    parser.add_argument('--saved_model', help='Path of saved model.', default="saved_model/model_onto4ner")
    parser.add_argument('--char_emb',
                        help='Path of character embedding file.',
                        default="/data2/lx/embeddings/gigaword_chn.all.a2b.uni.ite50.vec")
    parser.add_argument('--word_emb', help='Path of word embedding file.', default="/data2/lx/embeddings/ctb.50d.vec")
